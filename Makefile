...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Oct 12 12:14:03 2012
...
SOURCES       = mainwindow.cpp \
		...
		diagram/diagramactionmode.cpp .tmp/release/moc_mainwindow.cpp \
...
OBJECTS       = .tmp/release/mainwindow.o \
		...
		.tmp/release/addnodeactionmode.o \
		.tmp/release/diagramactionmode.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.h nodetype/nodetypecategoryitem.h nodetype/nodetypecategoryitemconnector.h nodetype/nodetypelistwidget.h nodetype/nodetypeitem.h diagram/svgnodeitem.h diagram/diagramview.h diagram/nodelabelitem.h diagram/diagramactionmode.h diagram/addnodeactionmode.h .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.cpp main.cpp nodetype/nodetypecategoryitem.cpp nodetype/nodetypecategoryitemconnector.cpp nodetype/nodetypelistwidget.cpp nodetype/nodetypeitem.cpp diagram/svgnodeitem.cpp diagram/diagramview.cpp diagram/nodelabelitem.cpp diagram/addnodeactionmode.cpp diagram/diagramactionmode.cpp .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/release/ddesigner1.0.0/ && (cd `dirname .tmp/release/ddesigner1.0.0` && $(TAR) ddesigner1.0.0.tar ddesigner1.0.0 && $(COMPRESS) ddesigner1.0.0.tar) && $(MOVE) `dirname .tmp/release/ddesigner1.0.0`/ddesigner1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/release/ddesigner1.0.0
...
.tmp/release/addnodeactionmode.o: diagram/addnodeactionmode.cpp diagram/addnodeactionmode.h \
		diagram/diagramactionmode.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/addnodeactionmode.o diagram/addnodeactionmode.cpp

.tmp/release/diagramactionmode.o: diagram/diagramactionmode.cpp diagram/diagramactionmode.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/diagramactionmode.o diagram/diagramactionmode.cpp
