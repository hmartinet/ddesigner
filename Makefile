...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Sun Oct 7 10:16:00 2012
...
SOURCES       = mainwindow.cpp \
		...
		diagram/actionpool.cpp .tmp/release/moc_mainwindow.cpp \
...
OBJECTS       = .tmp/release/mainwindow.o \
		...
		.tmp/release/addsvgnodeaction.o \
		.tmp/release/diagramaction.o \
		.tmp/release/freepointaction.o \
		.tmp/release/actionpool.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.h nodetype/nodetypecategoryitem.h nodetype/nodetypecategoryitemconnector.h nodetype/nodetypelistwidget.h nodetype/nodetypeitem.h diagram/svgnodeitem.h diagram/diagramview.h diagram/addsvgnodeaction.h diagram/diagramaction.h diagram/freepointaction.h diagram/actionpool.h .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.cpp main.cpp nodetype/nodetypecategoryitem.cpp nodetype/nodetypecategoryitemconnector.cpp nodetype/nodetypelistwidget.cpp nodetype/nodetypeitem.cpp diagram/svgnodeitem.cpp diagram/diagramview.cpp diagram/addsvgnodeaction.cpp diagram/diagramaction.cpp diagram/freepointaction.cpp diagram/actionpool.cpp .tmp/release/ddesigner1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/release/ddesigner1.0.0/ && (cd `dirname .tmp/release/ddesigner1.0.0` && $(TAR) ddesigner1.0.0.tar ddesigner1.0.0 && $(COMPRESS) ddesigner1.0.0.tar) && $(MOVE) `dirname .tmp/release/ddesigner1.0.0`/ddesigner1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/release/ddesigner1.0.0
...
.tmp/release/moc_diagramview.cpp: diagram/actionpool.h \
...
.tmp/release/addsvgnodeaction.o: diagram/addsvgnodeaction.cpp diagram/addsvgnodeaction.h \
		diagram/freepointaction.h \
		diagram/diagramaction.h \
		diagram/diagramview.h \
		diagram/actionpool.h \
		diagram/svgnodeitem.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/addsvgnodeaction.o diagram/addsvgnodeaction.cpp

.tmp/release/diagramaction.o: diagram/diagramaction.cpp diagram/diagramaction.h \
		diagram/diagramview.h \
		diagram/actionpool.h \
		diagram/freepointaction.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/diagramaction.o diagram/diagramaction.cpp

.tmp/release/freepointaction.o: diagram/freepointaction.cpp diagram/freepointaction.h \
		diagram/diagramaction.h \
		diagram/diagramview.h \
		diagram/actionpool.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/freepointaction.o diagram/freepointaction.cpp

.tmp/release/actionpool.o: diagram/actionpool.cpp diagram/actionpool.h \
		diagram/freepointaction.h \
		diagram/diagramaction.h \
		diagram/diagramview.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o .tmp/release/actionpool.o diagram/actionpool.cpp
