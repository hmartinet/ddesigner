...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Oct 19 00:07:22 2012
...
install_resources: first FORCE
	...
	-$(INSTALL_DIR) /home/hmartinet/ddesigner/resources/icons $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/
	-$(INSTALL_DIR) /home/hmartinet/ddesigner/resources/library $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/
	-$(INSTALL_DIR) /home/hmartinet/ddesigner/resources/style $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/


uninstall_resources:  FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/ddesigner.svg 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/icons 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/library 
	 -$(DEL_FILE) -r $(INSTALL_ROOT)/home/hmartinet/ddesigner/output/release/style
